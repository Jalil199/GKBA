"""
Driver: extended GKBA, position-representation leads, static spins (2 sites, 2 leads).
Corresponds to HFGKBA-beyond_bohr-posrep.ipynb / eGKBA_pos.ipynb.
"""

using DifferentialEquations
using DelimitedFiles
import GKBA: init_egkba_posrep, eom_egkba_posrep!, compute_observables!, unpack!
