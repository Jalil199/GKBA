"""
Driver: standard GKBA, position-representation leads, static spins (2 sites, 2 leads).
Corresponds to HFGKBA-posrep.ipynb.
"""

using DifferentialEquations
using DelimitedFiles
import GKBA: init_gkba_posrep, eom_gkba_posrep!, compute_observables!
import GKBA: unpack!, build_hs, build_hseα_posrep
