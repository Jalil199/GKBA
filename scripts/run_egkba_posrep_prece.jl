"""
Driver: extended GKBA, position-representation leads, precessing spins (2 sites, 2 leads).
Corresponds to HFGKBA-beyond-bohr_posrep-prece-.ipynb.
"""
...
elapsed = @elapsed begin
    for t in t_0:t_step:t_end - t_step
        ...
        dv.hseα_ikα = build_hseα_posrep(nx*ny, γc, nk) .* stepp(tt)
        @tullio dv.heαs_kαi[k,α,i] := conj(dv.hseα_ikα[i,k,α])
